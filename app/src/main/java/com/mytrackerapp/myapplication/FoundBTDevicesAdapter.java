...
public class FoundBTDevicesAdapter extends ArrayAdapter<BluetoothObject> {
    ...
    public FoundBTDevicesAdapter(Context context, ArrayList<BluetoothObject> arrayOfAlreadyPairedDevices) {
        super(context, R.layout.row_bt_scan_new_device, arrayOfAlreadyPairedDevices);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.row_bt_scan_new_device, parent, false);
        ...
        bt_address.setText("MAC Address: " + bluetoothObject.getBluetooth_address());
